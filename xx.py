...
class MemoryGUI:
    def __init__(self, root):
        ...
        self.root.configure(bg="#20b4e2")  # white
        ...
        tk.Button(root, text="Fragmentation", command=self.fragmentation).pack(pady=5)
        tk.Button(root, text="Efficiency", command=self.efficiency).pack(pady=5)
        tk.Button(root, text="Show Memory", command=self.display).pack(pady=5)
        ...
        self.output = tk.Text(root, height=15, width=80, bg="#FFFFFF", fg="#000000", font=("Courier New", 10), wrap="word")
